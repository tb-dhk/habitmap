...
import calendar
import math
import dateutil.relativedelta as dtut.rltdta
    ...
    while start <= end:
        ...
        for habit in lis:
            ...
            if habit == "overall":
                ...
                match bydur:
                    case "day":
                        ns = start + dtut.rltdta.relativedelta(days=1)
                    case "week":
                        if start.weekday() != 6:
                            ns = start
                            while ns.weekday != 6:
                                ns += dtut.rltdta.relativedelta(days=1)
                        else:
                            ns = start + dtut.rltdta.relativedelta(days=7)
                    case "month":
                        if start.day != 1:
                            ns = start
                            while ns.day != 1:
                            ...
                            ns = start + dtut.rltdta.relativedelta(months=+6)
                    case "year":
                        if start.day != 1 and start.month != 1:
                            ...
                            ns = start + dtut.rltdta.relativedelta(years=1)
